...
class GameFragment : Fragment() {
  ...
  override fun onCreateView(
    ...
    { view: View ->
      ...
      if (-1 != checkedId) {
        val answerIndex = getIndexFromRadioButtons(checkedId)
        ...
        if (answers[answerIndex] == currentQuestion.answers[0]) {
          ...
          if (questionIndex < numQuestions) {
            ...
            navigateToGameWon(view)
          }
        } else {
          navigateToGameOver(view)
        }
      }
    }
    return binding.root
  ...
  private fun getIndexFromRadioButtons(checkedId: Int) = when (checkedId) {
  ...
  private fun navigateToGameOver(view: View) {
